...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (blocked) {
      setError('Trop de tentatives échouées. Attendez avant de réessayer.');
      return;
    }
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    if (resetError) {
      ...
      setSuccessMsg('Email envoyé ! Vérifiez votre boîte mail pour réinitialiser votre mot de passe.');
    }
  };
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .lr { min-height: 100vh; display: flex; font-family: 'DM Sans', sans-serif; background: #F7F4F0; }
        ...
        .lr-brand-name { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 18px; color: white; letter-spacing: -0.02em; }

        .lr-left-content { position: relative; z-index: 1; }
        .lr-left-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 2.5rem; color: white; line-height: 1.12; letter-spacing: -0.03em; margin: 0 0 1rem; }
        ...
        .lr-stat-val { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 1.6rem; color: white; letter-spacing: -0.02em; }
        ...
        .lr-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 1.8rem; color: #0F172A; letter-spacing: -0.03em; margin: 0 0 6px; }
        ...
        .lr-eye {
          ...
          color: #94A3B8; font-size: 15px; line-height: 1; display: flex; align-items: center;
        ...
        .lr-success {
          ...
          padding: 10px 14px; margin-bottom: 1rem;
          font-size: 13px; color: #166534; line-height: 1.4;
          animation: fadeIn 0.2s ease-out;
        }
        ...
        .lr-link { font-size: 13px; color: #64748B; text-decoration: none; background: none; border: none; cursor: pointer; padding: 0; font-family: 'DM Sans', sans-serif; transition: color 0.15s; }
      ...
      <div className="lr">
        ...
        <div className="lr-left">
          ...
          <div className="lr-left-content">
            ...
            <p className="lr-left-sub">
              Tableau de bord familial, comparaison nationale
              et insights automatiques — tout pour piloter
              le budget de votre enfant sereinement.
            </p>
          </div>
          <div className="lr-stats">
            <div>
              <div className="lr-stat-val">100%</div>
              <div className="lr-stat-lbl">Données privées</div>
            </div>
            <div>
              <div className="lr-stat-val">0 €</div>
              <div className="lr-stat-lbl">Publicités</div>
            </div>
            <div>
              <div className="lr-stat-val">∞</div>
              <div className="lr-stat-lbl">Dépenses suivies</div>
            </div>
          </div>
        </div>
        ...
        <div className="lr-right">
          <div className="lr-wrap">
            ...
            <h1 className="lr-title">{resetMode ? 'Mot de passe\noublié' : 'Connectez-vous'}</h1>
            <p className="lr-sub">
              {resetMode
                ? 'Entrez votre email pour recevoir un lien de réinitialisation.'
                : 'Accédez à votre espace familial BabyBudget.'}
            </p>
            ...
            {!resetMode && (
              <form onSubmit={handleLogin} noValidate>
                <div className="lr-field">
                  ...
                  <input
                    id="email" type="email" className="lr-input"
                ...
                <div className="lr-field">
                  ...
                  <div className="lr-input-wrap">
                    <input
                      ...
                      className="lr-input pw" placeholder="••••••••" value={password}
                      onChange={(e) => { setPassword(e.target.value); setError(null); }}
                      autoComplete="current-password" required disabled={loading || blocked}
                    />
                    <button
                      type="button" className="lr-eye"
                ...
                {attempts > 0 && attempts < 5 && (
                  <p className="lr-attempts">
                    {5 - attempts} tentative{5 - attempts > 1 ? 's' : ''} restante{5 - attempts > 1 ? 's' : ''} avant blocage
                  </p>
                )}

                <button
                  type="submit"
                  className={`lr-btn${blocked ? ' danger' : ''}`}
            ...
            {resetMode && !successMsg && (
              <form onSubmit={handleReset} noValidate>
                <div className="lr-field">
                  ...
                  <input
                    id="reset-email" type="email" className="lr-input"
                    placeholder="vous@exemple.fr" value={email}
                    onChange={(e) => { setEmail(e.target.value); setError(null); }}
            ...
            {resetMode && successMsg && (
              <div className="lr-footer" style={{ marginTop: '1rem' }}>
                <button
                  type="button" className="lr-link accent"
