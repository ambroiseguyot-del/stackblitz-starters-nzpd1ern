    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sr { min-height: 100vh; display: flex; font-family: 'DM Sans', sans-serif; background: #F7F4F0; }
        ...
        .sr-left-bg {
          ...
          background:
            radial-gradient(ellipse at 25% 60%, rgba(16,185,129,0.15) 0%, transparent 55%),
        ...
        .sr-brand-name { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 18px; color: white; letter-spacing: -0.02em; }

        .sr-left-content { position: relative; z-index: 1; }
        .sr-left-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 2.4rem; color: white; line-height: 1.12; letter-spacing: -0.03em; margin: 0 0 1rem; }
        ...
        .sr-step-num {
          ...
          font-size: 12px; font-weight: 500; color: rgba(255,255,255,0.5); flex-shrink: 0; margin-top: 1px;
        }
        ...
        .sr-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 1.8rem; color: #0F172A; letter-spacing: -0.03em; margin: 0 0 6px; }
        ...
        .sr-strength-label { font-size: 11px; color: #94A3B8; }
        ...
        .sr-success-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 1.4rem; color: #0F172A; letter-spacing: -0.02em; margin: 0 0 8px; }
        ...
        <div className="sr-left">
          ...
          <div className="sr-left-content">
            <h2 className="sr-left-title">
              Créez votre<br />espace <span>familial</span><br />en 30 secondes
            </h2>
          ...
          <div className="sr-steps">
            ...
            <div className="sr-step">
              ...
              <div className="sr-step-text">
                <strong>Ajoutez vos enfants</strong>
                Un profil par enfant pour un suivi précis.
              </div>
            </div>
            <div className="sr-step">
              <div className="sr-step-num">3</div>
              <div className="sr-step-text">
                <strong>Suivez vos dépenses</strong>
                Graphiques, insights et comparaison nationale.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="sr-wrap">
            ...
            {sent ? (
              ...
              <div className="sr-success">
                ...
                <Link href="/login" className="sr-link accent" style={{ fontSize: 14 }}>
              ...
              <>
                ...
                <form onSubmit={handleSignUp} noValidate>
                  ...
                  <div className="sr-field">
                    ...
                    <input
                      id="email" type="email" className="sr-input"
                    ...
                    {password.length > 0 && (
                      <div className="sr-strength">
                        <div className="sr-strength-bar">
                          <div className="sr-strength-fill" style={{ width: strength.width, background: strength.color }} />
                        </div>
                        <span className="sr-strength-label" style={{ color: strength.color }}>{strength.label}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="sr-footer">
                    ...
                    <p style={{ fontSize: 13, color: '#64748B', margin: 0 }}>
                      Déjà un compte ?{' '}
                      <Link href="/login" className="sr-link accent">Se connecter</Link>
                    </p>
                  </div>
                </form>
              </>
